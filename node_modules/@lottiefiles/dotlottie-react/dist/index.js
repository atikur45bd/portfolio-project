...
var o0 = (() => {
  ...
  return function(i = {}) {
    ...
    var L1 = d.wasmBinary, M1, E1 = false, U1, r1, A, a1, u1, e1, E, b2, C2;
    function L22() {
      var e = M1.buffer;
      d.HEAP8 = r1 = new Int8Array(e), d.HEAP16 = a1 = new Int16Array(e), d.HEAPU8 = A = new Uint8Array(e), d.HEAPU16 = u1 = new Uint16Array(e), d.HEAP32 = e1 = new Int32Array(e), d.HEAPU32 = E = new Uint32Array(e), d.HEAPF32 = b2 = new Float32Array(e), d.HEAPF64 = C2 = new Float64Array(e);
    }
    var M2 = [], E2 = [], P2 = [];
    function p3() {
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var G3 = { c: (e, t, r, a) => {
      ...
      o = B(a, o), Q([], [e], (l) => {
        ...
        }, Q([], h, (f) => (f.splice(1, 0, null), l.Ba.La[t - 1] = X1(p, f, null, o, u), [])), [];
      });
    }, f: (e, t, r, a, o, u, h, l) => {
      var p = Y1(r, a);
      t = R(t), t = U2(t), u = B(o, u), Q([], [e], (f) => {
        function v() {
        ...
        var C = f.Ba.Ma, z = C[t];
        return z === void 0 || z.Ea === void 0 && z.className !== f.name && z.Na === r - 2 ? (v.Na = r - 2, v.className = f.name, C[t] = v) : (B2(C, t, w), C[t].Ea[r - 2] = v), Q([], p, (S) => (S = X1(w, S, f, u, h), C[t].Ea === void 0 ? (S.Na = r - 2, C[t] = S) : C[t].Ea[r - 2] = S, [])), [];
      });
      ...
      r = R(r), u = B(o, u), l = B(h, l), f = B(p, f), w = B(v, w), Q([e], [t], (C) => (C = C[0], [new g1(r, C.Ba, false, false, true, C, a, u, l, f, w)]));
    }, F: (e, t) => {
      t = R(t);
      var r = t === "std::string";
      ...
      function e(a) {
        var o;
        return P = a.exports, M1 = P.ga, L22(), j = P.ka, E2.unshift(P.ha), t1--, (o = d.monitorRunDependencies) == null || o.call(d, t1), t1 == 0 && (l1 && (a = l1, l1 = null, a())), P;
      }
      var t = { a: G3 };
