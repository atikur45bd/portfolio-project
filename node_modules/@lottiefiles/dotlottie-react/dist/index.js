...
var o0 = (() => {
  ...
  return function(i = {}) {
    var s, d = i, m, b, M = new Promise((e, t) => {
      m = e, b = t;
    }), I = Object.assign({}, d), D = "./this.program", O = "", d1;
    ...
    var L1 = d.wasmBinary, M1, E1 = false, U1, r1, A, a1, u1, Q, E, b2, C2;
    function L22() {
      var e = M1.buffer;
      d.HEAP8 = r1 = new Int8Array(e), d.HEAP16 = a1 = new Int16Array(e), d.HEAPU8 = A = new Uint8Array(e), d.HEAPU16 = u1 = new Uint16Array(e), d.HEAP32 = Q = new Int32Array(e), d.HEAPU32 = E = new Uint32Array(e), d.HEAPF32 = b2 = new Float32Array(e), d.HEAPF64 = C2 = new Float64Array(e);
    }
    var M2 = [], E2 = [], P2 = [];
    function p3() {
    ...
    function v3(e, t) {
      var r = h1;
      return L1 || typeof WebAssembly.instantiateStreaming != "function" || I2(r) || typeof fetch != "function" ? T2(r, e, t) : fetch(r, { credentials: "same-origin" }).then((a) => WebAssembly.instantiateStreaming(a, e).then(t, function(o) {
    ...
    var o1 = {}, t1 = {}, S1 = {}, v1, Z = (e, t, r) => {
      ...
      t.forEach((l, p) => {
        t1.hasOwnProperty(l) ? o[p] = t1[l] : (u.push(l), o1.hasOwnProperty(l) || (o1[l] = []), o1[l].push(() => {
    ...
    var G1 = (e) => {
    ...
    }, k2 = (e, t, r) => t === r ? e : r.Ga === void 0 ? null : (e = k2(e, t, r.Ga), e === null ? null : r.$a(e)), O2 = {}, y3 = {}, w3 = (e, t) => {
      if (t === void 0)
      ...
      return t.count = { value: 1 }, m1(Object.create(e, { Aa: { value: t, writable: true } }));
      ...
      var r = t.Aa;
      return r.Fa && J1.register(t, { Aa: r }, t), t;
    }, R2 = (t) => {
      J1.unregister(t);
    }, m1(e));
    function A1() {
    }
    var _1 = (e, t) => Object.defineProperty(t, "name", { value: e }), B2 = (e, t, r) => {
      if (e[t].Ea === void 0) {
        var a = e[t];
        e[t] = function(...o) {
          if (!e[t].Ea.hasOwnProperty(o.length))
            throw new y(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].Ea})!`);
          return e[t].Ea[o.length].apply(this, o);
        }, e[t].Ea = [], e[t].Ea[a.Na] = a;
      }
    }, q1 = (e, t, r) => {
      if (d.hasOwnProperty(e)) {
        if (r === void 0 || d[e].Ea !== void 0 && d[e].Ea[r] !== void 0)
          throw new y(`Cannot register public name '${e}' twice`);
        if (B2(d, e, e), d[e].Ea.hasOwnProperty(r))
    ...
    function L3(e, t, r, a, o, u, h, l) {
      this.name = e, this.constructor = t, this.Ma = r, this.Ka = a, this.Ga = o, this.bb = u, this.Qa = h, this.$a = l, this.jb = [];
    }
    var K1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.Qa)
    ...
    function g1(e, t, r, a, o, u, h, l, p, f, v) {
      this.name = e, this.Ba = t, this.Ta = r, this.Ra = a, this.Sa = o, this.ib = u, this.ob = h, this.Ya = l, this.Ua = p, this.kb = f, this.Ka = v, o || t.Ga !== void 0 ? this.toWireType = E3 : (this.toWireType = a ? M3 : P3, this.Ja = null);
    }
    var W2 = (e, t, r) => {
      if (!d.hasOwnProperty(e))
        throw new v1("Replacing nonexistent public symbol");
      d[e].Ea !== void 0 && r !== void 0 ? d[e].Ea[r] = t : (d[e] = t, d[e].Na = r);
    }, j, I3 = (e, t, r = []) => (e.includes("j") ? (e = e.replace(/p/g, "i"), t = (0, d["dynCall_" + e])(t, ...r)) : t = j.get(t)(...r), t), S3 = (e, t) => (...r) => I3(e, t, r), B = (e, t) => {
      e = R(e);
      ...
      function r(u) {
        o[u] || t1[u] || (S1[u] ? S1[u].forEach(r) : (a.push(u), o[u] = true));
      }
      var a = [], o = {};
    ...
    function X1(e, t, r, a, o) {
      ...
      return _1(e, function(...z) {
        ...
        for (var T = 0; T < f; ++T)
          v[T] = t[T + 2].toWireType(C, z[T]), w.push(v[T]);
        if (z = a(...w), l)
          V1(C);
        else
    ...
    var U2 = (e) => {
      ...
      var t = e2(e);
      return Q1(e), t;
    }, toWireType: (e, t) => x1(t), Ia: 8, readValueFromPointer: f1, Ja: null }, A3 = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? function(a) {
      ...
      var r = t1[e];
      if (r === void 0)
        throw e = `${t} has unknown type ${z2(e)}`, new y(e);
      return r;
    }, n2 = (e) => {
      if (e === null)
        return "null";
    ...
    }, D3 = Object.assign({ optional: true }, j2), H2 = typeof TextDecoder != "undefined" ? new TextDecoder("utf-16le") : void 0, R3 = (e, t) => {
      for (var r = e >> 1, a = r + t / 2; !(r >= a) && u1[r]; )
        ++r;
      if (r <<= 1, 32 < r - e && H2)
        return H2.decode(A.subarray(e, r));
      for (r = "", a = 0; !(a >= t / 2); ++a) {
        var o = a1[e + 2 * a >> 1];
        if (o == 0)
          break;
      ...
      if (!(e instanceof A2 || e == "unwind"))
        throw e;
    }, V2 = (e) => {
      var t;
      throw U1 = e, N1 || 0 < i2 || ((t = d.onExit) == null || t.call(d, e), E1 = true), new A2(e);
    }, H3 = (e) => {
      if (!E1)
        try {
          if (e(), !(N1 || 0 < i2))
    ...
    for (var q22 = Array(256), D1 = 0; 256 > D1; ++D1)
      q22[D1] = String.fromCharCode(D1);
    D2 = q22, y = d.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(A1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof A1 && e instanceof A1))
        return false;
      ...
      if (this.Aa.Ca || G1(this), this.Aa.Pa)
        return this.Aa.count.value += 1, this;
      var e = m1, t = Object, r = t.create, a = Object.getPrototypeOf(this), o = this.Aa;
      return e = e(r.call(t, a, { Aa: { value: { count: o.count, Oa: o.Oa, Pa: o.Pa, Ca: o.Ca, Da: o.Da, Fa: o.Fa, Ha: o.Ha } } })), e.Aa.count.value += 1, e.Aa.Oa = false, e;
    }, delete() {
      if (this.Aa.Ca || G1(this), this.Aa.Oa && !this.Aa.Pa)
    ...
    } }), Object.assign(g1.prototype, { cb(e) {
      return this.Ya && (e = this.Ya(e)), e;
    }, Wa(e) {
      var t;
      (t = this.Ka) == null || t.call(this, e);
    }, Ia: 8, readValueFromPointer: f1, fromWireType: function(e) {
      function t() {
        return this.Sa ? T1(this.Ba.Ma, { Da: this.ib, Ca: r, Ha: this, Fa: e }) : T1(this.Ba.Ma, { Da: this, Ca: e });
      }
      var r = this.cb(e);
      if (!r)
      ...
      var a = w3(this.Ba, r);
      if (a !== void 0)
        return a.Aa.count.value === 0 ? (a.Aa.Ca = r, a.Aa.Fa = e, a.clone()) : (a = a.clone(), this.Wa(e), a);
      if (a = this.Ba.bb(r), a = O2[a], !a)
        return t.call(this);
      a = this.Ra ? a.Za : a.pointerType;
      var o = k2(r, this.Ba, a.Ba);
      return o === null ? t.call(this) : this.Sa ? T1(a.Ba.Ma, { Da: a, Ca: o, Ha: this, Fa: e }) : T1(a.Ba.Ma, { Da: a, Ca: o });
...
` + a.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var G3 = { c: (e, t, r, a) => {
      ...
      var a = new m3(e);
      throw E[a.Ca + 16 >> 2] = 0, E[a.Ca + 4 >> 2] = t, E[a.Ca + 8 >> 2] = r, x2 = e, x2;
    }, D: function() {
      return 0;
    }, T: () => {
    }, Q: () => {
      ...
      Z([e], u, (h) => {
        ...
        return o.forEach((p, f) => {
          ...
          l[p.ab] = { read: (J) => v.fromWireType(w(C, J)), write: (J, w1) => {
            var U = [];
        ...
        }, Ia: 8, readValueFromPointer: f1, Ja: a }];
      });
    }, J: () => {
    }, _: (e, t, r, a) => {
      ...
      q1(z, function() {
        ...
        S = _1(v, function(...d2) {
          if (Object.getPrototypeOf(this) !== w1)
            throw new y("Use 'new' to construct " + v);
          if (U.La === void 0)
            throw new y(v + " has no accessible constructor");
          var e3 = U.La[d2.length];
          if (e3 === void 0)
            throw new y(`Tried to invoke ctor of ${v} with invalid number of parameters (${d2.length}) - expected (${Object.keys(U.La).toString()}) parameters instead!`);
        ...
        return T = new g1(v, U, true, false, false), b1 = new g1(v + "*", U, false, false, false), J = new g1(v + " const*", U, false, true, false), O2[e] = { pointerType: b1, Za: J }, W2(z, S), [T, b1, J];
      });
    }, q: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      o = B(a, o), Z([], [e], (l) => {
      ...
      t = R(t), t = U2(t), u = B(o, u), Z([], [e], (f) => {
        ...
        var C = f.Ba.Ma, z = C[t];
        return z === void 0 || z.Ea === void 0 && z.className !== f.name && z.Na === r - 2 ? (v.Na = r - 2, v.className = f.name, C[t] = v) : (B2(C, t, w), C[t].Ea[r - 2] = v), Z([], p, (S) => (S = X1(w, S, f, u, h), C[t].Ea === void 0 ? (S.Na = r - 2, C[t] = S) : C[t].Ea[r - 2] = S, [])), [];
      });
    }, Z: (e) => H(e, j2), y: (e, t, r, a) => {
      function o() {
      }
      t = R(t), o.values = {}, H(e, { name: t, constructor: o, fromWireType: function(u) {
        return this.constructor.values[u];
      }, toWireType: (u, h) => h.value, Ia: 8, readValueFromPointer: A3(t, r, a), Ja: null }), q1(t, o);
    }, k: (e, t, r) => {
      var a = t2(e, "enum");
      t = R(t), e = a.constructor, a = Object.create(a.constructor.prototype, { value: { value: r }, constructor: { value: _1(`${a.name}_${t}`, function() {
      }) } }), e.values[r] = a, e[t] = a;
    }, E: (e, t, r) => {
      t = R(t), H(e, { name: t, fromWireType: (a) => a, toWireType: (a, o) => o, Ia: 8, readValueFromPointer: F3(t, r), Ja: null });
    }, v: (e, t, r, a, o, u) => {
      var h = Y1(t, r);
      ...
      H(e, { name: t, fromWireType: o, toWireType: h, Ia: 8, readValueFromPointer: x3(t, r, a !== 0), Ja: null });
    }, h: (e, t, r) => {
      function a(u) {
      ...
      r = R(r), u = B(o, u), l = B(h, l), f = B(p, f), w = B(v, w), Z([e], [t], (C) => (C = C[0], [new g1(r, C.Ba, false, false, true, C, a, u, l, f, w)]));
    }, F: (e, t) => {
      t = R(t);
      var r = t === "std::string";
      H(e, { name: t, fromWireType: function(a) {
        ...
        if (r)
          ...
          for (f = Array(o), l = 0; l < o; ++l)
            f[l] = String.fromCharCode(A[u + l]);
          f = f.join("");
        }
        return X(a), f;
      ...
      if (r = R(r), t === 2)
        var a = R3, o = k3, u = O3, h = (l) => u1[l >> 1];
      else
        t === 4 && (a = B3, o = W3, u = $3, h = (l) => E[l >> 2]);
      H(e, { name: r, fromWireType: (l) => {
        for (var p = E[l >> 2], f, v = l + 4, w = 0; w <= p; ++w) {
          var C = l + 4 + w * t;
          (w == p || h(C) == 0) && (v = a(v, C - v), f === void 0 ? f = v : (f += "\0", f += v), v = C + t);
        }
        return X(l), f;
      }, toWireType: (l, p) => {
        if (typeof p != "string")
      ...
      }, Ia: 8, readValueFromPointer: f1, Ja(l) {
        X(l);
      } });
    }, x: (e, t, r, a, o, u) => {
      I1[e] = { name: R(t), Ua: B(r, a), Ka: B(o, u), Xa: [] };
    }, j: (e, t, r, a, o, u, h, l, p, f) => {
      I1[e].Xa.push({ ab: R(t), gb: r, eb: B(a, o), fb: u, mb: h, lb: B(l, p), nb: f });
    }, $: (e, t) => {
      ...
      throw 1 / 0;
    }, ca: (e, t, r, a) => (e = r2[e], t = e2(t), e(null, t, r, a)), G: Q1, ba: (e, t, r) => {
      var a = U3(e, t), o = a.shift();
      e--;
      var u = Array(e);
      return t = `methodCaller<(${a.map((h) => h.name).join(", ")}) => ${o.name}>`, z3(_1(t, (h, l, p, f) => {
        for (var v = 0, w = 0; w < e; ++w)
          u[w] = a[w].readValueFromPointer(f + v), v += a[w].Ia;
        return l = r === 1 ? j3(l, u) : l.apply(h, u), h = [], l = o.toWireType(h, l), h.length && (E[p >> 2] = x1(h)), l;
      }));
    }, da: (e) => {
      9 < e && (Y[e + 1] += 1);
    }, aa: (e) => {
      var t = e2(e);
      V1(t), Q1(e);
    }, o: (e, t) => (e = t2(e, "_emval_take_value"), e = e.readValueFromPointer(t), x1(e)), L: (e, t) => {
      if (y1[e] && (clearTimeout(y1[e].id), delete y1[e]), !t)
        return 0;
      var r = setTimeout(() => {
        delete y1[e], H3(() => Y2(e, performance.now()));
      }, t);
      return y1[e] = { id: r, qb: t }, 0;
    }, M: (e, t, r, a) => {
      var o = (/* @__PURE__ */ new Date()).getFullYear(), u = new Date(o, 0, 1).getTimezoneOffset();
      o = new Date(o, 6, 1).getTimezoneOffset(), E[e >> 2] = 60 * Math.max(u, o), Q[t >> 2] = +(u != o), t = (h) => {
        var l = Math.abs(h);
      ...
      return E[a >> 2] = o, 0;
    }, i: X3, d: Y3, e: K3, p: Z3, z: t0, b: J3, a: q3, g: e0, n: Q3, H: n0, W: V2, P: (e, t) => (J2(A.subarray(e, e + t)), 0) }, P = function() {
      var r;
      function e(a) {
        var o;
        return P = a.exports, M1 = P.ga, L22(), j = P.ka, E2.unshift(P.ha), e1--, (o = d.monitorRunDependencies) == null || o.call(d, e1), e1 == 0 && (l1 && (a = l1, l1 = null, a())), P;
      }
      var t = { a: G3 };
      if (e1++, (r = d.monitorRunDependencies) == null || r.call(d, e1), d.instantiateWasm)
        try {
    ...
    d.dynCall_iijj = (e, t, r, a, o, u) => (d.dynCall_iijj = P.qa)(e, t, r, a, o, u), d.dynCall_vijj = (e, t, r, a, o, u) => (d.dynCall_vijj = P.ra)(e, t, r, a, o, u), d.dynCall_jiii = (e, t, r, a) => (d.dynCall_jiii = P.sa)(e, t, r, a), d.dynCall_jii = (e, t, r) => (d.dynCall_jii = P.ta)(e, t, r);
    var X2 = d.dynCall_vijjj = (e, t, r, a, o, u, h, l) => (X2 = d.dynCall_vijjj = P.ua)(e, t, r, a, o, u, h, l);
    d.dynCall_jiji = (e, t, r, a, o) => (d.dynCall_jiji = P.va)(e, t, r, a, o), d.dynCall_viijii = (e, t, r, a, o, u, h) => (d.dynCall_viijii = P.wa)(e, t, r, a, o, u, h), d.dynCall_iiiiij = (e, t, r, a, o, u, h) => (d.dynCall_iiiiij = P.xa)(e, t, r, a, o, u, h), d.dynCall_iiiiijj = (e, t, r, a, o, u, h, l, p) => (d.dynCall_iiiiijj = P.ya)(e, t, r, a, o, u, h, l, p), d.dynCall_iiiiiijj = (e, t, r, a, o, u, h, l, p, f) => (d.dynCall_iiiiiijj = P.za)(e, t, r, a, o, u, h, l, p, f);
    function J3(e, t) {
      var r = G();
      try {
        j.get(e)(t);
    ...
    function Z2() {
      function e() {
        var r;
        if (!R1 && (R1 = true, d.calledRun = true, !E1)) {
...
var L = class L2 {
  ...
  get layout() {
    ...
    if (n)
      return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
        var s, d, m, b, M, I;
        switch (n.fit) {
          case ((s = L2._wasmModule) == null ? void 0 : s.Fit.Contain):
            return "contain";
          case ((d = L2._wasmModule) == null ? void 0 : d.Fit.Cover):
            return "cover";
          case ((m = L2._wasmModule) == null ? void 0 : m.Fit.Fill):
            return "fill";
          case ((b = L2._wasmModule) == null ? void 0 : b.Fit.FitHeight):
            return "fit-height";
          case ((M = L2._wasmModule) == null ? void 0 : M.Fit.FitWidth):
            return "fit-width";
          case ((I = L2._wasmModule) == null ? void 0 : I.Fit.None):
            return "none";
          default:
            return "contain";
        }
  ...
  get mode() {
    ...
    return n === ((s = L2._wasmModule) == null ? void 0 : s.Mode.Reverse) ? "reverse" : n === ((d = L2._wasmModule) == null ? void 0 : d.Mode.Bounce) ? "bounce" : n === ((m = L2._wasmModule) == null ? void 0 : m.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(n) {
    ...
    this._dotLottieCore === null || L2._wasmModule === null || (this._dotLottieCore.setConfig({ themeId: (i = n.themeId) != null ? i : "", autoplay: (s = n.autoplay) != null ? s : false, backgroundColor: 0, loopAnimation: (d = n.loop) != null ? d : false, mode: m2((m = n.mode) != null ? m : "forward", L2._wasmModule), segment: y2((b = n.segment) != null ? b : [], L2._wasmModule), speed: (M = n.speed) != null ? M : 1, useFrameInterpolation: (I = n.useFrameInterpolation) != null ? I : true, marker: (D = n.marker) != null ? D : "", layout: n.layout ? { align: g2(n.layout.align, L2._wasmModule), fit: _2(n.layout.fit, L2._wasmModule) } : L2._wasmModule.createDefaultLayout() }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), this.setBackgroundColor((O = n.backgroundColor) != null ? O : ""));
  }
  _render() {
  ...
  setBackgroundColor(n) {
    this._dotLottieCore !== null && (x && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = n : this._dotLottieCore.setConfig(k(F({}, this._dotLottieCore.config()), { backgroundColor: s3(n) })), this._backgroundColor = n);
  }
  setLoop(n) {
  ...
  setSegment(n, i) {
    this._dotLottieCore === null || L2._wasmModule === null || this._dotLottieCore.setConfig(k(F({}, this._dotLottieCore.config()), { segment: y2([n, i], L2._wasmModule) }));
  }
  setMode(n) {
    this._dotLottieCore === null || L2._wasmModule === null || this._dotLottieCore.setConfig(k(F({}, this._dotLottieCore.config()), { mode: m2(n, L2._wasmModule) }));
  }
  setRenderConfig(n) {
    let m = n, { devicePixelRatio: i, freezeOnOffscreen: s } = m, d = O1(m, ["devicePixelRatio", "freezeOnOffscreen"]);
    this._renderConfig = k(F(F({}, this._renderConfig), d), { devicePixelRatio: i || i1(), freezeOnOffscreen: s != null ? s : true }), x && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? $.observe(this._canvas, this) : $.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? W.observe(this._canvas, this) : (W.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(n) {
  ...
  setLayout(n) {
    this._dotLottieCore === null || L2._wasmModule === null || this._dotLottieCore.setConfig(k(F({}, this._dotLottieCore.config()), { layout: { align: g2(n.align, L2._wasmModule), fit: _2(n.fit, L2._wasmModule) } }));
  }
  setViewport(n, i, s, d) {
  ...
  static transformThemeToLottieSlots(n, i) {
    var s, d;
    return (d = (s = L2._wasmModule) == null ? void 0 : s.transformThemeToLottieSlots(n, i)) != null ? d : "";
  }
};
...
var q = class q2 {
  constructor(n) {
    ...
    this._worker = q2._workerManager.getWorker(i), q2._workerManager.assignAnimationToWorker(this._id, i), q2._wasmUrl && this._sendMessage("setWasmUrl", { url: q2._wasmUrl }), this._create(k(F({}, n), { renderConfig: k(F({}, n.renderConfig), { devicePixelRatio: ((s = n.renderConfig) == null ? void 0 : s.devicePixelRatio) || i1(), freezeOnOffscreen: (m = (d = n.renderConfig) == null ? void 0 : d.freezeOnOffscreen) != null ? m : true }) })), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this)), this._pointerUpMethod = this._onPointerUp.bind(this), this._pointerDownMethod = this._onPointerDown.bind(this), this._pointerMoveMethod = this._onPointerMove.bind(this), this._pointerEnterMethod = this._onPointerEnter.bind(this), this._pointerExitMethod = this._onPointerLeave.bind(this);
  }
  ...
  _create(n) {
    return g(this, null, function* () {
      ...
      let { instanceId: s } = yield this._sendMessage("create", F({ instanceId: this._id, config: k(F({}, n), { canvas: i }) }, l3(this._canvas)), [i]);
      if (s !== this._id)
  ...
  play() {
    return g(this, null, function* () {
      this._created && (yield this._sendMessage("play", { instanceId: this._id }), yield this._updateDotLottieInstanceState(), x && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !$1(this._canvas) && (yield this.freeze()));
    });
  }
  pause() {
    return g(this, null, function* () {
